...
import es.curso.gestorfacturas.LineaDeFactura;
...
//			System.out.println(c);
		...
		cli = new Cliente("343434A", "SRT", "Orense 5");
		Factura f = new Factura(1, cli);
		f.addLinea(new LineaDeFactura(3, new Articulo(1, "portatil", 550)));
		f.addLinea(new LineaDeFactura(2, new Articulo(2, "mesa", 80)));
